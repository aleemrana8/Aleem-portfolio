...
function MetricCard({
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 rounded-xl border border-[#1d3a5c] bg-[#112240]/60 backdrop-blur-sm hover:border-[#64ffda]/40 transition-all duration-300"
    >
      {/* Hover glow */}
      <div className="absolute inset-0 rounded-xl bg-[#64ffda]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="p-3 rounded-lg bg-[#64ffda]/10 mb-4 group-hover:bg-[#64ffda]/20 transition-colors">
          <Icon className="w-6 h-6 text-[#64ffda]" />
        </div>
        <p className="text-3xl md:text-4xl font-bold text-[#ccd6f6]">
          {count.toLocaleString()}
          <span className="text-[#64ffda]">{suffix}</span>
        </p>
  ...
  return (
    <section className="py-24 px-6" id="metrics">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p className="text-[#64ffda] font-mono text-sm mb-2 tracking-wider">By The Numbers</p>
